...
# #' Fit a mixed decomposable graphical model
# #'
# #' A generic method for structure learning in mixed decomposable graphical models
# #' 
# #' @param d data.frame
# #' @param tree Logical indicating whether or not the function should fit a tree
# #' or a general decomposable mixed graph
# #' @param hom Logical.
